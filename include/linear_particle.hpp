...
namespace mc_particle
{
    ...
    class linear_particle {
     ...
     public:
        ...
        [[nodiscard]] str gradual_color_static_instantaneous(
        ...
        [[nodiscard]] str gradual_color_static_spiral_sequential(
            const particle_rgba_tick_parameter_options &opt,
            const vector3D<real_number> &from, const vector3D<real_number> &to,
            bool clockwise, real_number_cref rad_bias, real_number_cref circles,
        ...
        [[nodiscard]] str solid_color_expand_spiral_instantaneous_file(
            ...
            real_number_cref radius, real_number_cref resistence) const;
        ...
        [[nodiscard]] str gradual_color_expand_spiral_instantaneous_file(
            const particle_parameter_options &opt,
            const mc_function &target_file, const vector3D<real_number> &from,
            const vector3D<real_number> &to, bool clockwise,
            real_number_cref rad_bias, real_number_cref circles,
        ...
        [[nodiscard]] str gradual_color_expand_spiral_sequential_file(
            const particle_parameter_options &opt,
            const mc_function &target_file, const vector3D<real_number> &from,
            const vector3D<real_number> &to, bool clockwise,
            real_number_cref rad_bias, real_number_cref circles,
...
#include "linear_particle/gradual_color_static_instantaneous_impl.hpp"
#include "linear_particle/gradual_color_static_spiral_sequential.hpp"
#include "linear_particle/gradual_color_expand_spiral_instantaneous_file.hpp"
#include "linear_particle/gradual_color_expand_spiral_sequential_file.hpp"
